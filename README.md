...
Привет, меня зовут Джемеви ![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif)
=====================================================================================================================================

Я Jemewy, разработчик Fronted 🚀
--------------------------------

🔭 сейчас работаю над своим веб-сайтом 🌱 сейчас изучаю HTML, CSS и JavaScript ⚡ Интересный факт: я использую табуляцию вместо пробелов
